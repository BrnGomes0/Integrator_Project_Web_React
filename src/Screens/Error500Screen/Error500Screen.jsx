...
// Definindo o componente PageError500
function PageError500() {
    // Estrutura JSX para a página de erro 500
    return (
        ...
        <section className="bg-[#252525] flex flex-col justify-center items-center text-white pt-20">
            ...
            <div className="w-1/2 flex justify-center text-center pb-24">
                {/* Título de erro com o número 500 e o nome "BuBo" */}
...
// Exportando o componente PageError500
