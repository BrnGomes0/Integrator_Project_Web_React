    ...
    return(
        <section className="bg-[#252525] pt-16 flex justify-center items-center gap-8 p-28">
            <div className="w-1/2 flex flex-col gap-4 justify-center items-center p-20">
                ...
                <img src="https://images.pexels.com/photos/6667892/pexels-photo-6667892.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" className="w-full rounded-lg w-[49rem] h-[38rem]"/>
            </div>
